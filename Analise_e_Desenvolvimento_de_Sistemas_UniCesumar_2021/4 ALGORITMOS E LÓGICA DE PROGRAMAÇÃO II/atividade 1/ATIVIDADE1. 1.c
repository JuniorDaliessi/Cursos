...
int main(){
    ...
    printf("  Salários reajustados até R$ 1.750,00 Reais");
    printf("\n  Receberá um abono de R$ 150,00 Reais\n");

    printf("\n  Qauntidade de FUNCIONÁRIOS para calculo DO REAJUSTE: ");
    scanf("%d",&qFuncionarios);
    struct funcionarios func[qFuncionarios];

    for(i=0;i<qFuncionarios;i++){
        printf("\n  Cadastrando o(a) %d° de %d funcionários(a): ",i+1,qFuncionarios);
        printf("\n*******************************************");
        printf("\n  Informe o nome do(a) %d° funcionário(a): ",i+1);
        fflush(stdin);
        gets(func[i].nome);
        printf("\n  Informe o salário líquido do(a) funcionário(a) %s: R$ ",func[i].nome);
        fflush(stdin);
        ...
        printf("\n  LISTAGEM COMPLETA\n");
    	printf("--------------------------------------------------------------\n");
    	printf("  FUNCIONÁRIOS\t\tSALARIO_LIQUIDO\t\tSALÁRIO_FINAL\n\n");
    	for (i=0; i<qFuncionarios; i++){
